...
const CartItem = ({ cartItem }) => {
  ...
  return (
    <article key={cartId} className='mb-12 flex flex-col gap-y-4 sm:flex-row flex-wrap border-b border-base-30 pb-6 last:border-b-0' >
        ...
        <div className='sm:ml-16 sm:w-48'>
            ...
            {/* COMPANY  */}
            {/* COLOR */}
            <p className='mt-2 text-sm capitalize flex item-center gap-x-2'>
                color: 
        ...
        <div className="sm:ml-12">
            ...
            {/* REMOVE */}
            <button className='mt-2 link link-primary link-hover text-sm' onClick={removeItmFromTheCart}>
                Remove
            </button>
        </div>
